#' Chapter 6 Baboon_Variable_Descriptions
#'
...
#' @docType data
#' @keywords datasets
#' @name Baboon_Variable_Descriptions
#' @usage Baboon_Variable_Descriptions
#' @format A data frame with nine rows and four columns
"Baboon_Variable_Descriptions"
...
#' Chapter 6 Table_6.12
#'
#' Many people with cocaine addictions also suffer from mood disorders like depression or a manicdepressive disorder.
...
#' @name Table_6.7
#' @usage Table_6.7
#' @format A data frame with six rows and two columns
"Table_6.7"
